...
begin
  ...
  try
    ...
    if SearchText <> '' then
      ...
      FProducts := ProductService.GetProductsByCategory(CategoryID)
    else
      FProducts := ProductService.GetAllProducts;
...
begin
  // Check permissions
  if not AuthService.CurrentUser.CanEditProduct then
  begin
...
begin
  ...
  // Check permissions
  if not AuthService.CurrentUser.CanDeleteProduct then
  begin
  ...
  TDialogService.MessageDialog(
    ...
    begin
      ...
      begin
        if ProductService.DeleteProduct(Product.ProductID) then
          LoadProducts;
      end;
    end);
end;
