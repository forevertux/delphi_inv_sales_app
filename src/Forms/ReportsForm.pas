...
begin
  ...
  FCurrentDataSet := nil;
  FReportAutoGenerated := False;
end;

procedure TfrmReports.ResetAutoReport;
begin
  FReportAutoGenerated := False;
end;
...
begin
  LoadBranches;
  if not FReportAutoGenerated then
  begin
    FReportAutoGenerated := True;
