...
begin
  FCurrentSale.Clear;
  FCurrentSale.SaleNumber := SalesService.GenerateSaleNumber;
  FCurrentSale.SaleDate := Now;
  FCurrentSale.EmployeeID := AuthService.CurrentUser.UserID;
  FCurrentSale.BranchID := AuthService.CurrentUser.BranchID;
...
begin
  ...
  try
    FProducts := ProductService.SearchProducts(SearchText);
...
begin
  ...
  // Check permissions
  if not AuthService.CurrentUser.CanProcessSale then
  begin
  ...
  TDialogService.MessageDialog(
    ...
    begin
      ...
      begin
        if SalesService.CreateSale(FCurrentSale) then
        begin
